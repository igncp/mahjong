...
pub struct Play {
    ...
    pub waiting: bool,
    pub service_client: ServiceHTTPClient,
}
...
impl Play {
    ...
    pub fn is_current_player(&self) -> bool {
        if self.mode == Some(PlayMode::Admin) {
            return true;
        }
    ...
    pub async fn get_games(&mut self) {
        ...
        let games = self
            .service_client
            .get_games(if self.mode == Some(PlayMode::User) {
    ...
    pub async fn wait_for_message(&mut self) -> Result<PlayEvent, String> {
